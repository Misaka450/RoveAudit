...
import { Button, Space, Table, Tag, message, Upload, Modal, Tabs } from 'antd';
import { UploadOutlined, DownloadOutlined, FileExcelOutlined } from '@ant-design/icons';
import { read, utils, write } from 'xlsx';
import { userApi } from '@/api';

/**
 * 用户批量导入组件（从 UserPage 拆分出来）
 * 包含：上传 Excel → 预览数据 → 确认导入 → 查看结果
 */
export default function UserBatchImport({
  visible,
  onClose,
  onSuccess,
}: {
